...
export const partners: Partner[] = [
  ...
  // Premium Partners
  { id: 'nebulus', name: 'NEBULUS', logoUrl: '/images/partners/nebulus.png', websiteUrl: 'https://nebulus.world', tier: 'premium', logoScale: 1.3, logoFilter: 'brightness(6) saturate(0.6)' },
  ...
  { id: 'sky-mavis', name: 'Sky Mavis', logoUrl: '/images/partners/sky-mavis.png', websiteUrl: 'https://skymavis.com', tier: 'premium', logoScale: 1.8 },
  ...
  { id: 'risemount', name: 'Risemount', logoUrl: '/images/partners/risemount.svg', websiteUrl: 'https://risemountresortdanang.com', tier: 'premium', logoScale: 2.4 },
